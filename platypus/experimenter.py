...
def experiment(algorithms = [],
    ...
    for job in job_results:
        ...
        if job.algorithm_name.split('_')[0] == "IMGAMO":
            results[job.algorithm_name][job.problem_name].append(job.instance.nfe)
            results[job.algorithm_name][job.problem_name].append(job.instance.iterate_num)
            results[job.algorithm_name][job.problem_name].append(job.instance.time_e - job.instance.time_s)
        count += 1
